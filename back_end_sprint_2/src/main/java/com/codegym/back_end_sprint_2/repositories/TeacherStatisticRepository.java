...
@Repository
public interface TeacherStatisticRepository extends JpaRepository<Teacher, String> {
    @Query(value="select p.teacher_code as teacher_code, t.`name` as teacher_name, count(p.teacher_code) as number_of_registers\n" +
            "from project p\n" +
